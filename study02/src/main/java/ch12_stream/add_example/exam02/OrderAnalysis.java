package ch12_stream.add_example.exam02;
...
public class OrderAnalysis {
    ...
    public static void main(String[] args) {
        ...
        int[] idArray = orders.stream().filter(
                order ->
        ...
        System.out.println("총액 100만원 이상 주문 ID : " + Arrays.toString(idArray));

        // 2. 각 고객별 총 주문 금액을 계산하여 맵으로 반환하기
        Map<String, Double> totalPrice = orders.stream()
        ...
        System.out.println("고객별 총 주문 금액:" + totalPrice);
